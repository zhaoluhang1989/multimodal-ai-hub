...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const state = {
        ...
        imageModel: { provider: 'gemini', model: 'gemini-3-flash-preview' },
        chatModel: { provider: 'gemini', model: 'gemini-3-flash-preview' },
        visionModel: { provider: 'gemini', model: 'gemini-3-flash-preview' },
        imageRatio: '1:1',
        imageCount: 1,
        chatHistory: [],
        uploadedImage: null,
